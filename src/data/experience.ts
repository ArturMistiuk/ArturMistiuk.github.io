...
export const experience: ExperienceItem[] = [
  // ── Work ──────────────────────────────────────────────────────
  {
    ...
    endDate: 'Present',
    description: [
      'Supported machine learning and data products through labeling and quality assurance of financial transaction datasets.',
      'Monitored labeling quality across markets using dashboards and helped maintain consistent data standards.',
      'Worked on Merchant Information validation, ensuring predicted merchant attributes were accurate and reliable.',
      'Trained and coordinated a temporary team of data labelers, including running standups and workshops.',
    ],
